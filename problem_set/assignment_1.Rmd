---
title: "Assignment 1: R markdown template"
...
- For this assignment, please **reproduce this markdown file exactly as shown** using R markdown (including this list of instructions). You do **NOT** need to fill out the code chunks (i.e. answer the questions) for this assignment. We are just practicing markdown formatting right now.  
...
- You will have to submit your assignment through GitHub. You can complete your template after Thursday’s class, but don’t worry about submitting it until after we have gone over how to submit it through GitHub in next Tuesday’s class. To do so, you will first move `assignment_1.Rmd` and `assignment_1.md` to the `problem_sets` folder in your own GitHub repository that you have created in class through GitHub Classroom. (If you haven’t created this repo yet, please use the following url: [https://classroom.github.com/a/o8r_gQtD](https://classroom.github.com/a/o8r_gQtD)). Then, you can stage these files, make a commit, and push the commit.
...
```{r show-rows, echo=TRUE, eval=FALSE}
...
```{r hdi-cpi, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r color-points, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r color-region, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r size-points, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r line-points, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r straight-line, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r each-Region, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r distribution-density, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r distribution-histogram, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r distribution-boxplot, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r countries-plot, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r theoph-data, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>  
...
```{r theoph-dataset, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>  
...
```{r weight-dataset, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>  
...
```{r dose-time, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r quantity-dose, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>
...
```{r conc-dose, echo=TRUE, eval=FALSE}
## Write your code here
```
<br>

## Exercise 3. Unemployment in the US 1967-2015 (OPTIONAL)  
This excercise uses the dataset `economics` from the ggplot2 package. It was produced from US economic time series data available from url:[http://research.stlouisfed.org/fred2](http://research.stlouisfed.org/fred2]). It describes the number of unemployed persons (`unemploy`), among other variables, in the US from 1967 to 2015.

```{r head-eco, echo=TRUE, eval=FALSE}
...
```{r trend-unemployed, echo=TRUE, eval=FALSE}
 ## Write your code here
```
...
```{r edit-plot, echo=TRUE, eval=FALSE}
 ## Write your code here
```
